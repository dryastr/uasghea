...
<footer class="py-4 mt-auto" style="background-color: #1cbbc1;border-top:1px solid white;">
    <div class="container-fluid px-4">
        <div class="d-flex align-items-center justify-content-between small">
            <div  class="text-muted"><span style="color: white;">Copyright</span> <span style="color: white;">&copy; ghea</span> </div>
            <div>
